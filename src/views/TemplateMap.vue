    ...
    <div id="content" v-if="getRoleMion" >
      ...
      <b-container fluid id="tp-size">
        <b-row v-if="!getPushDomainStat">
          <b-col> <h1 class="title">Map</h1></b-col>
          <b-col
            ><i class="fas fa-print fa-2x" @click="printWindow()"></i
          ></b-col>
        </b-row>
        <div class="row">
          <div class="col-lg-6">
...
import TemplatePointMap from "@/components/map/TemplatePointMap.vue";
import TemplatePostMap from "@/components/map/TemplatePostMap.vue";
