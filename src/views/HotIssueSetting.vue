<template>
  <div id="overflow-page">
    ...
    <div>
      <h4 class="title-domain"><router-link :to="{name:'HotIssue'}">Hot Issue </router-link> 
        <i class="fas fa-angle-right"/><span id="active"> การจัดการ </span> </h4> 
    </div>
    <TableIssue/>
...
import TableIssue from "@/components/hotissue/TableIssue.vue";
...
export default {
  ...
  computed: {
    ...mapGetters(["getLoadStatus", "getToSection"]),
  }
}
</script>
<style scoped>
