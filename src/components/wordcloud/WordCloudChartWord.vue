<template>
  <div>
    <b-row align-h="center" style="margin-top: 2em">
      <div class="cardChart footer_margin">
        ...
        <b-row>
          ...
          <ColumnChart
            :chartDataColumn="getWordCloudWordChart"
            class="d-none"
          />
          <b-col sm="12" md="12" lg="12">
            <div>
              ...
              <b-row
                v-for="(word, index) in getWordChart.slice(0, 10)"
                v-bind:key="index"
                align-h="center"
                ...
                <div>
                  ...
                  >
                    <b-col>
                      ...
                      <span
                        ><i class="fas fa-paper-plane"></i>
                        {{ getSentimentBlockditPost | numFormat }}
                      </span>
                    </b-col>
                    <b-col>
                      <span>Comments</span><br />
                      <span
                        ><i class="fas fa-comments"></i>
                        {{ getSentimentBlockditComment | numFormat }}
                      </span>
                    </b-col>
                  </b-row>
                  <!-- End Post and comment/retweet founds -->
                  ...
                  >
                    <b-col>
                      ...
                      <span
                        ><i class="fas fa-paper-plane"></i>
                        {{ getSentimentTiktokPost | numFormat }}
                      </span>
                    </b-col>
                    <b-col>
                      <span>Comments</span><br />
                      <span
                        ><i class="fas fa-comments"></i>
                        {{ getSentimentTiktokComment | numFormat }}
                      </span>
                    </b-col>
                  </b-row>
                  <!-- End Post and comment/retweet founds -->
              ...
              <b-col sm="12" md="12" lg="6" align-h="right">
                ...
                <b-row style="height: 20em">
                  <b-col>
                    ...
                    >
                      <span id="day">
                        <Sentimentv2 :chartData="getSentimentFacebook" />
                      </span>
                    </span>
                    <span
                      class=""
                    ...
                    >
                      <span id="day">
                        <Sentimentv2 :chartData="getSentimentTwitter" />
                      </span>
                    </span>
                    <span
                      class=""
                    ...
                    >
                      <span id="day">
                        <Sentimentv2 :chartData="getSentimentPantip" />
                      </span>
                    </span>
                    <span
                      class=""
                    ...
                    >
                      <span id="day">
                        <Sentimentv2 :chartData="getSentimentYoutube" />
                      </span>
                    </span>
                    <span
                      class=""
                    ...
                    >
                      <span id="day">
                        <Sentimentv2 :chartData="getSentimentInstagram" />
                      </span>
                    </span>
                    <span
                      class=""
    ...
    <div class="pb-5 conpost" v-if="!tab_selected">
      ...
      <WordPost :checkpost="true" id="wordsll" />
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters([
      ...
      "getSentimentBlockditComment",
      "getSentimentTiktokComment",
