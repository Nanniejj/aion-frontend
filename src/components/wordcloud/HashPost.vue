<template>
  <div id="wordcloud">
    <vue-element-loading :active="getLoadPostHash" size="80" background-color="rgba(255, 255, 255, 0.5)"
      color="#b6ac9a" />
          ...
          <span id="post-comment">
            ...
            <b>
              <span v-if="getSentimentHashtagDetail.count !== 0">
                {{ getSentimentHashtagDetail.count | numFormat }} </span><span v-else> 0 </span></b>
            โพสต์
          </span>
        </b-col>
      </b-row>
        ...
        <b-col sm="12" md="12" lg="6" id="tab-post">
          <b-row>
            ...
            <b-col cols="12" v-if="!checkpost">
              ...
              <span v-if="getHashtagSocial === 'facebook'"><img src="@/assets/Facebook.png" width="50px"
                  id="img-title" />
              </span>
              <span v-if="getHashtagSocial === 'twitter'"><img src="@/assets/Twitter.png" width="50px" id="img-title" />
              </span>
              <span v-if="getHashtagSocial === 'pantip'"><img src="@/assets/Pantip.png" width="50px" id="img-title" />
              </span>
              <span v-if="getHashtagSocial === 'youtube'"><img src="@/assets/Youtube.png" width="50px" id="img-title" />
              </span>
              <span v-if="getHashtagSocial === 'news'"><img src="@/assets/News.png" width="50px" id="img-title" />
              </span>
              <span v-if="getHashtagSocial === 'instagram'"><img src="@/assets/Instagram.png" width="50px"
                  id="img-title" />
              </span>
              <span id="post-comment">
                <i class="far fa-paper-plane" />
    ...
    border-radius: 13px;">
        ...
        " class="text-left ai-box my-3 text-small px-3" style="font-size: 13px;font-weight: 500; color: #2c3e50;">
      ...
      if (this.checked) {
        ...
        if (this.andkey.length) {
          this.andkey.forEach(function (key) {
            // console.log("keyyyy", key, key.length);
            if (
              key.length == 2 &&
