  ...
  <div>
    ...
    border-radius: 13px;"
            ...
            <template #footer>
              ...
              <span
                v-if="postDomain.retweets_count !== '0' && postDomain.retweets_count"
                id="box-reaction"
                v-b-tooltip.hover
                title="Retweet"
              >
              ...
              <span
                v-if="postDomain.likes_count !== '0' && postDomain.likes_count"
                id="box-reaction"
                v-b-tooltip.hover
                title="Like"
              >
              ...
              <span
                v-if="postDomain.shares_count !== '0' && postDomain.shares_count"
                id="box-reaction"
                v-b-tooltip.hover
                title="Share"
              >
              ...
              <span
                v-if="postDomain.views_count !== '0' && postDomain.views_count"
                id="box-reaction"
                v-b-tooltip.hover
                title="View"
              >
