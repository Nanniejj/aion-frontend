...
import StaticTimeline from '@/components/rankingperson/StaticTimeline.vue'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const API_URL = 'https://api2.cognizata.com/api/v2/facerecognition/getPerosonPostCharts'
