<template>
  <div>
    ...
    <vue-element-loading :active="getLoadTopUserPf" size="80" background-color="rgba(255, 255, 255, 0.5)"
      color="#b6ac9a" />
    <b-row class="mt-3" cols-sm="2" cols-md="3" cols-lg="5" cols="1" v-if="topuser.length">
      <b-col v-for="(user, k) in topuser" :key="k">
        <div class="box-topuser mb-3">
          ...
          <a :href="user.url_post" target="_blank">
            <b-avatar badge-variant="info" variant="light" :src="user.profile_image" :size="80"
              class="shadow-sm rounded">
              <template #badge id="bb">
                <img v-if="user.source == 'facebook'" src="@/assets/Facebook.png" class="social-img" />
                <img v-if="user.source == 'twitter'" src="@/assets/Twitter.png" class="social-img" />
                <img v-if="user.source == 'news'" src="@/assets/News.png" class="social-img" />
                <span v-if="user.source == 'pantip'">
                  <img v-if="user.platform == 'dek-d'" src="@/assets/dekd.png" class="social-img" />
                  <img v-else-if="user.platform == 'lemon8'" src="@/assets/lemon8.png" class="social-img" />
                  <img v-else src="@/assets/Pantip.png" class="social-img" />
                </span>

                <img v-if="user.source == 'instagram'" src="@/assets/Instagram.png" class="social-img" />
                <img v-if="user.source == 'youtube'" src="@/assets/Youtube.png" class="social-img" />
                <img v-if="user.source == 'blockdit'" src="@/assets/Blockdit.png" class="social-img" />
                <img v-if="user.source == 'tiktok'" src="@/assets/Tiktok.png" class="social-img" />
                <img v-if="user.source == 'threads'" src="@/assets/Threads.png" class="social-img" />
                <img v-if="user.source == 'telegram'" src="@/assets/Telegram.png" class="social-img" />
              </template> </b-avatar></a>
          <div class="mt-2 textuser bold">
            <a :href="user.url_post" target="_blank">{{ user.account_name }}</a>
          </div>
          <span class="badge badge-pill badge-dark px-2 py-1"
            style="font-size: 13px;background-color: #4c412b;cursor: pointer"
            @click="linkToProfile(user)">ดูโปรไฟล์</span>
          <div class="mt-3" v-if="
            user.source !== 'news' &&
          ...
          ">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
          ...
          <b-row cols="1" v-else>
            ...
            <b-col v-b-tooltip.hover title="reply" v-if="user.source == 'twitter'">
              <b-row cols="12">
                <b-col><i class="fa fa-comments-o" aria-hidden="true"></i></b-col>
                <b-col class="text-left">
          ...
          <!-- ig engage -->
          <b-row v-if="user.source == 'instagram' || user.source == 'tiktok'" id="score-data" cols-lg="auto" cols="1"
            cols-md="1" class="d-none">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
                <b-col class="text-left">
          ...
          <!-- fb engage -->
          <b-row v-if="user.source == 'facebook'" id="score-data" cols-lg="auto" cols="1" cols-md="1" class="d-none">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
          ...
          <!-- blockdit engage -->
          <b-row v-if="user.source == 'blockdit'" id="score-data" cols-lg="auto" cols="1" cols-md="1" class="d-none">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
                <b-col class="text-left"> {{ user.allPost | numFormat }}</b-col>
          ...
          <!-- tw engage -->
          <b-row v-if="user.source == 'twitter'" id="score-data" cols-lg="auto" cols="1" cols-md="1" class="d-none">
          ...
          <!-- news pantip -->
          <b-row v-if="user.source == 'pantip'" id="score-data" cols-lg="auto" cols="1" cols-md="1" class="d-none">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
                <b-col class="text-left"> {{ user.allPost | numFormat }}</b-col>
            ...
            <b-col v-b-tooltip.hover title="likes">
              <b-row>
                <b-col>
                  <i class="fa fa-thumbs-up" aria-hidden="true"></i></b-col>
                <b-col class="text-left">
                  {{ user.likes_count | numFormat }}</b-col>
              </b-row>
            </b-col>
          ...
          <!-- News --------------->
          <b-row v-if="user.source == 'news'" id="score-data" cols-lg="auto" cols="1" cols-md="1" class="d-none">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
                <b-col class="text-left"> {{ user.allPost | numFormat }}</b-col>
          ...
          <!-- youtube -->
          <b-row v-if="user.source == 'youtube'" id="score-data" cols-lg="auto" cols="1" cols-md="1" class="d-none">
            <b-col v-b-tooltip.hover title="posts">
              <b-row>
                <b-col><i class="fa fa-paper-plane-o" aria-hidden="true"></i></b-col>
                <b-col class="text-left"> {{ user.allPost | numFormat }}</b-col>
            ...
            <b-col v-b-tooltip.hover title="likes">
              <b-row>
                <b-col><i class="fa fa-thumbs-up" aria-hidden="true"></i></b-col>
                <b-col class="text-left">
                  {{ user.likes_count | numFormat }}</b-col>
              </b-row>
            </b-col>
            <b-col v-b-tooltip.hover title="dislike">
              <b-row>
                <b-col>
                  <i class="fa fa-thumbs-down" aria-hidden="true"></i></b-col>
                <b-col class="text-left">
