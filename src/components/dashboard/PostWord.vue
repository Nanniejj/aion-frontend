          ...
          <b-row>
            <b-col cols="12">
              ...
              <span id="post-comment">
                ...
                <b> {{ getSentimentPost.count.toLocaleString() }} </b> โพสต์ |
                <i class="far fa-comments" />
                <b> {{ getSentimentPost.total_comment.toLocaleString() }} </b>
                คอมเม้นต์</span
              >
            </b-col>
          </b-row>
      ...
      >
        <template #header>
          <b-row>
            <b-col style="text-align: initial;display: contents;">
              <img
                v-if="datas.photo == undefined || datas.photo == ''"
                :src="user"
                loading="lazy"
                class="user-img"
              />
            ...
            <b-col style="text-align: initial;">
              <span v-if="datas.source !== 'twitter'" id="user-name">
                <a
                  v-if="
                    datas.original_post != undefined &&
                      datas.original_post != ''
                  "
                  v-bind:href="datas.original_post"
                  target="_blank"
                >
              ...
              <div id="text-date" style="text-align: start" class="md-font">
                <span v-if="datas.source == 'twitter'">
                  ...
                  {{ new Date(datas.date).getHours() + 7 }}:{{
                    new Date(datas.date).getMinutes()
                  }}:{{ new Date(datas.date).getSeconds() }}
                </span>
                <span v-else>
                  {{ new Date(datas.date).getDate() }} /
                  {{ new Date(datas.date).getMonth() + 1 }} /
        ...
        <b-row no-gutters>
                  ...
                  >
                    <a target="_blank" v-bind:href="datas.snapshot">
                      <img
                        v-if="
                          datas.snapshot !== null &&
                            datas.snapshot !== undefined
                        "
                        v-bind:src="datas.snapshot"
                        loading="lazy"
                        id="img-popup"
                      />
                    </a>
                  ...
                  <div
                    v-else-if="
                      datas.source == 'facebook' &&
                        String(datas.snapshot).includes('scontent')
                    "
                  >
                    <a target="_blank" v-bind:href="datas.snapshot">
                      <img
                      ...
                      <img
                        v-if="
                          datas.snapshot !== null &&
                            datas.snapshot !== undefined
                        "
                        v-bind:src="imageLink + datas.snapshot"
                        loading="lazy"
                        id="img-popup"
                      />
                    </a>
          ...
          <b-col md="3" v-if="datas.snapshot">
            ...
            >
              <img
                v-if="datas.snapshot !== null && datas.snapshot !== undefined"
                v-bind:src="datas.snapshot"
          ...
          <div class="comment-img">
            ...
            <span>
              <i
                ...
                v-popover.top="{ name: 'foo' + k }"
                style="cursor:pointer;"
              >
              </i>
              <span class="md-font" v-if="datas.comment_count !== undefined">
                {{ Number(datas.comment_count).toLocaleString() }}&nbsp;</span
              >
            </span>
            ...
            <span v-if="datas.reaction">
              <span v-if="datas.reaction != ''">
                ...
                <span v-if="datas.reaction.Good != undefined">
                  <span
                    v-if="
                      datas.reaction.Good !== '0' &&
                        datas.reaction.Good != undefined
                    "
                    id="box-reaction"
                    v-b-tooltip.hover
                    title="Good Content"
                  >
                    ...
                    <span class="md-font">
                      {{ datas.reaction.Good.toLocaleString() }}
                    </span>
                  </span>
                </span>
                <span v-if="datas.reaction.Horror">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Horror !== '0'">
                      {{ datas.reaction.Horror.toLocaleString() }}
                    </span>
                  </span>
                </span>
                <!-- pt -->
                ...
                <span v-if="datas.reaction.Like">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Like !== '0'">
                      {{ datas.reaction.Like.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.share">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.share !== '0'">
                      {{ datas.reaction.share.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.Love">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Love !== '0'">
                      {{ datas.reaction.Love.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.Wow">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Wow !== '0'">
                      {{ datas.reaction.Wow.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.Haha">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Haha !== '0'">
                      {{ datas.reaction.Haha.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.Sad">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Sad !== '0'">
                      {{ datas.reaction.Sad.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.Angry">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Angry !== '0'">
                      {{ datas.reaction.Angry.toLocaleString() }}
                    </span>
                  </span>
                </span>
                <span v-if="datas.reaction.Hug">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.Hug !== '0'">
                      {{ datas.reaction.Hug.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                >
                  <span
                    ...
                    <span
                      ...
                      v-if="datas.reaction.view_count !== ''"
                    >
                      {{ datas.reaction.view_count.toLocaleString() }}
                    </span>
                  </span>
                </span>
                <span v-if="datas.reaction.likes">
                  ...
                  >
                    ...
                    <span class="md-font" v-if="datas.reaction.likes !== '0'">
                      {{ datas.reaction.likes.toLocaleString() }}
                    </span>
                  </span>
                </span>
                ...
                <span v-if="datas.reaction.dislikes">
                  ...
                  >
                    ...
                    <span class="md-font">
                      {{ datas.reaction.dislikes.toLocaleString() }}
                    </span>
                  </span>
                </span>
                <!-- end yt -->
