              ...
              <b-row>
                <b-col cols="12">
                  ...
                  <span id="post-comment">
                    ...
                    <b>
                      {{ getSentimentPost.total_comment.toLocaleString() }}
                    </b>
                    คอมเม้นต์</span
                  >
                </b-col>
              ...
              <b-row>
                ...
                <b-col style="text-align: initial;">
                  <span id="user-name"
                    ...
                    <a class="fa fa-link" target="_blank"></a> <br />11/02/2021
                    เวลา 12:20 น
                  </span>
                </b-col>
                <b-col sm="12" md="4">
    ...
    border-radius: 13px;"
          ...
          >
            ...
            <b-row no-gutters>
              <b-col md="3">
                <b-card-img
                  src="https://pht.qoo-static.com/DtgfIQ-puwmf9_BVCXqpjBODP-Lb0lGjwUnDHhtgtZL__vrAeDwNjV8u9hhEAbZrx0XL=w300"
                  alt="Image"
                  class="rounded-0"
                  height="100%"
                  style="object-fit: cover;"
          ...
          >
            ...
            <b-row no-gutters>
              <b-col md="3">
                <b-card-img
                  src="https://d1o7cxaf8di5ts.cloudfront.net/file/media/origin/2020_02_13/c81e1a7821b31331.jpg"
                  alt="Image"
                  class="rounded-0"
                  height="100%"
                  style="object-fit: cover;"
