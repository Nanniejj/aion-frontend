    ...
    <div class="mt-5 p-1">
      <b-row class="mb-1">
        <b-col md="8" lg="8" class="m-auto my-1">
          <h5
            class="bold text-lg-left text-md-left"
            v-if="getDomainReport == 'none'"
          >
            ไม่มี Domain
          </h5>
          <h5
            class="bold text-lg-left text-md-left"
            v-else-if="getDomainReport"
          >
            {{ getDomainReport }}
          </h5>
...
export default {
  ...
  methods: {
    ...
    page() {
      var pageNumber;
      if (
        parseInt(this.gotopage) > Math.ceil(this.getCntReport / 10) ||
