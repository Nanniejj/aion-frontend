<template>
  <div>
    ...
    <div class="text-left">
      ...
      <div class="d-inline-block" v-if="startd">
      ...
      <div v-else  class="d-inline-block twodate "> <span class="h6">ALL</span></div>
    </div>
            ...
            <b-col>
              <b-row>
                ...
                <b-col cols="auto">
                  <div class="text-icon">
                    <b>{{
                      (dataStat.comments_count + dataStat.totalPost) | numFormat
                    }}</b>
                    <br />
                    Messages
                  </div>
...
export default {
  ...
  watch: {
    ...
    dates(val){
        this.apiStat(val[0], val[1])
        // let s =val[0].slice(0, 10);
        this.startd =val[0].slice(0, 10);
        this.endd =val[1].slice(0, 10);
        console.log(val);
    }
  },
  computed: {
  ...
  methods: {
    ...
    async apiStat(start, end) {
      var config = {
        method: "get",
        url:
          API_V2_URL+"/api/v2/keyword/getKeywordStat?keyword=" +
          this.keywords +
          "&start=" +
          start +
          "&end=" +
