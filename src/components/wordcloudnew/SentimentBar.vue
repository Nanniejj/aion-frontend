<template>
  <b-row cols="1">
    ...
    <b-col class="mb-1">
      <b-row class="v-cen">
        <b-col cols="auto">
          <i class="far fa-smile fa-2x d-inline" style="color: #339737;"></i>
        </b-col>
        <b-col>
    ...
    <b-col class="mb-1">
      <b-row class="v-cen">
        <b-col cols="auto">
          <i class="far fa-meh fa-2x d-inline" style="color: rgb(226, 171, 53);;"></i>
        </b-col>
        <b-col>
    ...
    <b-col class="mb-1">
      <b-row class="v-cen">
        <b-col cols="auto">
          <i class="far fa-frown-open fa-2x d-inline" style="color: rgb(201, 49, 43);"></i>
        </b-col>
        <b-col>
