          ...
          <div>
            <div>
              ...
              <input
                ...
                v-model="force"
              />
              {{ parseInt(options.force).toLocaleString() }}
              ...
              <d3-network
                :ref="svg"
                :net-nodes="getNodesTopInfluencer"
                :net-links="getLinksTopInfluencer"
                :options="options"
              />
            </div>
          </div>
    ...
    <b-row>
      <b-col cols="" class="table-responsive">
        ...
        >
          ...
          <tbody>
            <tr
              v-for="(item, index) in getLinksDataTopInfluencer"
              v-bind:key="index"
...
export default {
  ...
  mounted() {
    console.log("########", this.getLinksTopInfluencer);
  },
  computed: {
    ...mapGetters([
      "getDataTopInfluencer",
      "getLinksTopInfluencer",
      "getLinksDataTopInfluencer",
      "getNodesTopInfluencer",
      "getNodeLink",
      "getLinksTop",
    ]),
