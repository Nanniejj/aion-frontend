        ...
        <b-row v-if="type === 'hashtaglist'" class="m-0">
            <b-col xl="4" class="px-0 pr-xl-3">
                <div class="gradient-bg h-100">
                    <b-row v-if="profile" class="m-0">
                        <b-col class="py-3">
                            <span>
                                <b-avatar v-if="type == 'hashtaglist'" style="color: #776167;" text="#"
                                    class="shadow-sm rounded badge-light rounded-circle" size="140px">
                                </b-avatar>
                                <b-avatar v-else size="140px" class="p-1 bg-white border border-light shadow">
                                    <span v-if="data.profile_image">
                                        <b-avatar :src="data.profile_image" @error="setAltImg" size="120px"
                                            loading="lazy" class="shadow-sm rounded badge-light rounded-circle shadow">
                                        </b-avatar>
                                    </span>
                                    <span v-else>
                                        <b-avatar class="shadow-sm rounded badge-light rounded-circle" size="120px">
                                        </b-avatar>
                                    </span>
                                </b-avatar>
                                ...
                                <span v-if="selectedSource === 'all'" class="left">
                                    <b-avatar class="" size="45" text="All"
                                        style="background-color: #fed16e;left: -30px;"></b-avatar>
                                </span>
                            </span>
                            <div class="h6 py-2">
                                <a v-if="type == 'hashtaglist'" class="" v-bind:href="profile.link_original"
                                    target="_blank" style="color: #776167;">
                                    <h4 class="py-2 text-truncate" v-if="type === 'hashtaglist'">{{ profile.uid }}</h4>
                                    ({{ totalPost | numFormat }} posts)
                                </a>
                                <a v-else class="d-flex align-items-center justify-content-center"
                                    v-bind:href="profile.link_original" target="_blank" style="color: #776167;">
                                    <h4 v-if="profile.target_type === 'group'" class="py-2 mb-0 text-truncate">{{
                                        profile.name || profile.uid }}</h4>
                                    <h4 v-else class="py-2 mb-0 text-truncate">{{ profile.name || data.account_name ||
                                        profile.uid }}</h4>
                            ...
                            <b-col v-if="type == 'hashtaglist'">
                                <date-picker v-model="valueDate" type="date" range placeholder="เลือกช่วงเวลา" size="sm"
                                    :disabled-date="(date) => date >= new Date()" value-type="format"
                                    format="YYYY-MM-DD" id="date-domain" class="w-100" @change="checkDateRange()">
                                    {{ valueDate }}
                                </date-picker>
                                <b-button v-if="selectedSource !== 'all'" variant="info" pill :pressed="false"
                                    @click="resetSource" class="shadow-r px-4 my-4">All Platform</b-button>
                            </b-col>
                        </b-col>
            ...
            <b-col xl="8" class="text-left px-0 pl-lg-3">
                <b-card-text v-if="type === 'hashtaglist'" class="my-2">
                    <HashtagBarChar :start="valueDate[0]" :end="valueDate[1]"
                        @update-source="(data) => setHashtagSource(data)" @totalPost="(data) => totalPost = data" />
                </b-card-text>
                <b-card-text v-if="type !== 'hashtaglist'" class="my-2">
                    ...
                    <div v-if="!editable" class="col-12">
                        <b-row>
                            <b-col cols="12 mb-2 px-0">
                                <b-badge v-if="profile.species" variant="info" class="mr-1 text-capitalize" pill>{{
                                    getSpeciesName(profile.species) }}</b-badge>
                                <b-badge v-if="profile.department" class="mr-2"
                                    style="background-color: #fed06ea4; color: #2c3e50;" pill>
                            ...
                            <b-col cols="12" class="text-left">
                                <b-row cols="2" cols-sm="4" class="">
                                    ...
                                    <b-col class="my-2">
                                        <b-row class="justify-content-center text-center">
                                            <b-col cols="12">
                                                <i class="fas fa-transgender-alt fa-2x d-inline"
                                                    style="color: #fed06ea4;" />
                                            </b-col>
                                            <b-col cols="12">
                                                <div class="text-icon text-center">
                                    ...
                                    <b-col class="my-2">
                                        <b-row class="justify-content-center text-center">
                                            <b-col cols="12">
                                                <i class="fa fa-birthday-cake fa-2x d-inline"
                                                    style="color: #fed06ea4;" />
                                            </b-col>
                                            <b-col cols="12">
                                                <div class="text-icon text-center">
                            ...
                            <!-- influencer type -->
                            <b-row v-if="profile.influencer_type && profile.influencer_type.length !== 0"
                                class="m-0 w-100 ">
                                <div class="col-12 pt-3">
                                    <b-row cols="1" cols-sm="2" cols-lg="4" class="px-5 py-3 w-100"
                                        style="background-color: #fed06ea4; border-radius: 90px;">
                                        <b-col v-for="(item, index) in profile.influencer_type.length > 4
                                            ? profile.influencer_type.slice(0, 3)
                                            : profile.influencer_type.slice(0, 4)" :key="index">
                                            <b-row class="text-center">
                                                <b-col cols="12" class="">
                                                    <b-avatar v-if="getIcon(item).startsWith('fa-')" size="4rem"
                                                        style="background-color: #17a2b8;">
                                                        <i class="fas" :class="getIcon(item)"
                                                            style="font-size: 2rem;"></i>
                                                    </b-avatar>

                                                    <!-- ถ้าไม่ใช่ fa- ให้ใช้แบบ icon ปกติ -->
                                                    <b-avatar v-else :icon="getIcon(item)"
                                                        style="background-color: #17a2b8;" size="4rem"></b-avatar>
                                        ...
                                        <b-col v-if="profile.influencer_type && profile.influencer_type.length > 4">
                                            <b-row class="text-center">
                                                <b-col cols="12">
                                                    <b-avatar :text="`+${profile.influencer_type.length - 3}`"
                                                        size="4rem"></b-avatar>
                                                </b-col>
                    ...
                    <div v-else class="col-12 px-0">
                        <b-row cols="1" cols-sm="1" cols-md="2" class="mx-0">
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-input size="sm" class="input" placeholder="ระบุชื่อบัญชี"
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    <b-col class="text-secondary d-flex p-0 align-items-center">
                                        ...
                                        <i v-if="editable" class="fa fa-exclamation-circle mx-1 text-info"
                                            v-b-tooltip.hover
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-input size="sm" class="input" placeholder="ระบุที่อยู่รูปโปรไฟล์"
                                ...
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-select size="sm" class="input"
                                            ...
                                            v-model="selectedData.species" placeholder="เลือกหมวดหมู่" />
                                    </div>
                                </b-row>
                            </b-col>
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <div v-else class="col-12 px-0">
                                        <b-form-select size="sm" class="input" :options="influConditions"
                                ...
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-select size="sm" class="input"
                                            ...
                                            v-model="selectedData.department" placeholder="เลือกหมวดหมู่" />
                                    </div>
                                </b-row>
                            </b-col>
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    <b-col class="text-secondary d-flex p-0 align-items-center">
                                        ...
                                        <i class="fa fa-exclamation-circle mx-1 text-info" v-b-tooltip.hover
                                            title="ระดับ 1 = ความถี่ต่ำ,ระดับ 2 = ความถี่ปานกลาง,ระดับ 3 = ความถี่สูง"
                                            style="font-size: 14px; cursor: pointer;"></i> :
                                    </b-col>
                                    <div class="col-12 px-0">
                                        <b-form-select size="sm" class="input" :options="[1, 2, 3]"
                                            v-model="selectedData.bot_level" placeholder="เลือกระดับ" />
                                    </div>
                                </b-row>
                            </b-col>
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-select size="sm" class="input" :options="sexs"
                                            v-model="selectedData.sex" placeholder="เลือกเพศ" />
                                    </div>
                                </b-row>
                            </b-col>
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <b-form-spinbutton id="demo-sb" size="sm" v-model="selectedData.age" min="0"
                                ...
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-select size="sm" class="input"
                                            ...
                                            placeholder="เลือกจังหวัด" v-model="province_id"
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-select :disabled="!province_id" size="sm" class="input"
                                            :options="[{ value: null, text: 'เลือกอำเภอ' }, ...districts]"
                                            placeholder="เลือกอำเภอ" v-model="district_id"
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <div class="col-12 px-0">
                                        <b-form-select :disabled="!district_id" size="sm" class="input"
                                            :options="[{ value: null, text: 'เลือกตำบล' }, ...subDistricts]"
                                            placeholder="เลือกตำบล" v-model="subDistrict_id" />
                                    </div>
                                </b-row>
                            </b-col>
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <b-form-input size="sm" type="text" v-model="selectedData.followers"
                                        @keypress="onlyNumber" placeholder="กรอกจำนวนผู้ติดตาม (เฉพาะตัวเลข)" />
                                </b-row>
                            </b-col>
                            ...
                            <b-col class="px-0 px-md-1 mb-2">
                                <b-row class="w-100 m-0">
                                    ...
                                    <b-form-input size="sm" type="text" v-model="selectedData.following"
                                        @keypress="onlyNumber"
                        ...
                        <b-col cols="12" class="px-0 px-md-1 mb-2">
                            <b-row class="w-100 m-0">
                                ...
                                <div class="col-12 px-0">
                                    <Multiselect v-model="selectedData.influencer_type" :options="influencerTypes"
                                        :multiple="true" :taggable="true" label="text" track-by="value"
        ...
        <b-row v-else>
            <b-col cols="12" sm="auto" class="px-3">
                <b-avatar size="140px" class="p-1 bg-white border border-light shadow">
                    <span v-if="data.profile_image">
                        <b-avatar :src="data.profile_image" @error="setAltImg" size="140px" loading="lazy"
                            class="shadow-sm rounded badge-light rounded-circle shadow">
                        </b-avatar>
                    </span>
                    <span v-else>
                        <b-avatar class="shadow-sm rounded badge-light rounded-circle" size="140px">
                        </b-avatar>
                    </span>
                </b-avatar>
                <b-col cols="auto" v-if="selectedSource" class="right">
                    <img v-if="selectedSource == 'twitter'" src="@/assets/Twitter.png" class="social-img" />
                    <img v-else-if="selectedSource == 'facebook'" src="@/assets/Facebook.png" class="social-img" />
                    <img v-if="selectedSource == 'news'" src="@/assets/News.png" class="social-img" />
                    <img v-if="selectedSource == 'pantip'" src="@/assets/Pantip.png" class="social-img" />
                    <img v-if="selectedSource == 'instagram'" src="@/assets/Instagram.png" class="social-img" />
                    <img v-if="selectedSource == 'youtube'" src="@/assets/Youtube.png" class="social-img" />
                    <img v-if="selectedSource == 'blockdit'" src="@/assets/Blockdit.png" class="social-img" />
                    <img v-if="selectedSource == 'tiktok'" src="@/assets/Tiktok.png" class="social-img" />
                    <img v-if="selectedSource == 'threads'" src="@/assets/Threads.png" class="social-img" />
                </b-col>
            </b-col>
            <b-col>
                <b-row class="justify-content-center justify-content-sm-start">
                    ...
                    <b-col cols="12" class="text-sm-left">
                        ...
                        <b-badge v-if="profile.sex" pill :class="'badge-' + profile.sex">{{ getsexTh(profile.sex)
                        }}</b-badge>
                    </b-col>
                    ...
                    <b-col cols="12" class="mt-1">
                        <b-row class="justify-content-center justify-content-sm-start">
                            <b-col cols="auto">
                                <span class="text-info bold" style="font-size: 18px;">{{ formatNumber(profile.followers)
                                }}</span> Followers
                            </b-col>
                            <b-col cols="auto">
                                <span class="text-info bold" style="font-size: 18px;">{{
                                    formatNumber(profile.followings) }}</span> Following
                            </b-col>
                        </b-row>
                    </b-col>
                    ...
                    <b-col cols="12" class="mt-1 text-left"
                        v-if="profile.influencer_type && profile.influencer_type.length !== 0">
                        <b-badge v-for="(item, index) in profile.influencer_type" :key="index" variant="warning"
                            class="mx-1" style="background-color: #fed16e;">
...
/>
        ...
        <b-row id="timeline-container" class="m-0">
                            ...
                            <b-col cols="12" md="7">
                                <b-row class="m-0">
                                    <b-form-group label="" label-for="kw" class="flex-grow-1">
                                        <b-form-input id="kw" v-model.trim="search" placeholder="Enter keyword" />
                                    </b-form-group>
                                    <b-button type="submit" variant="info" class="ml-2 px-2 mb-3" :disabled="loading">
                                        ค้นหา keyword
                                    </b-button>
                                </b-row>
                            </b-col>
                            ...
                            <b-col cols="12" md="4">
                                <section id="date-picker">
                                    <date-picker v-model="valueDate" type="date" range placeholder="เลือกช่วงเวลา"
                                        class="w-100" size="sm" :disabled-date="(date) => date >= new Date()"
                                        value-type="format" format="YYYY-MM-DD" @change="checkDateRange()"
            ...
            <b-col v-if="type === 'hashtaglist'" cols="12" class="px-0 py-2 rounde-lg"
                :style="{ backgroundColor: !showTimeline ? '#EBFDFF' : '' }">
            ...
            <b-col v-if="type === 'hashtaglist' && showTimeline" cols="12" class="px-0">
                ...
                <vue-element-loading :active="loading" class="h-100" size="80"
                    background-color="rgba(255, 255, 255, 0.3)" color="#b6ac9a" />
                <b-col v-if="timelinePosts.length > 0 && (next_offset || offset > 0)" class="p-0">
                    <b-row v-if="(timelinePosts.length < totalTimelinePost)" @click="viewMore"
                        class="justify-content-md-center align-items-center my-3 mx-0">
        ...
        <!-- posts -->
        <TabPost :source="selectedSource" :start="valueDate[0]" :end="valueDate[1]" :topDomain="topDomain"
            :isBottom="alreadyAtBottom" :keyWord="keyWord" :sentiment="selected" :sortBy="selectedSort"
            @totalPost="data => totalPost = data" @update:start="data => valueDate = [data, valueDate[1]]"
            @update:end="data => valueDate = [valueDate[0], data]" @update-source="data => setHashtagSource(data)" />
    </div>
</template>
<script>
...
import WordcloudDomain from "@/components/domain/WordcloudDomain.vue";
...
export default {
    ...
    data() {
        ...
        return {
            ...
            wordcloudDomainData: null,
            wordcloudDomainLoading: false,
            wordcloudDomainError: '',
            icon: [],
            keyWord: null,
    ...
    methods: {
        ...
        getResolvedSourceParam() {
            if (this.selectedSource === 'all') {
                return 'news,twitter,facebook,youtube,tiktok,blockdit,instagram,pantip,threads,telegram';
            }
            return this.selectedSource || '';
        },
        buildWordcloudDomainParams() {
            const params = {
                source: this.getResolvedSourceParam() || 'news,twitter,facebook,youtube,tiktok,blockdit,instagram,pantip,threads,telegram',
            ...
            if (type) {
                ...
                //   delete params.start;
                //   delete params.end;
                //   params.account = this.$route.query.id;
                }
            }
            if (id) {
                params.id = id;
        ...
        async getWordCloudImage() {
            this.wordcloudDomainLoading = true;
            this.wordcloudDomainError = '';

            try {
                const domainConfig = {
                    method: "get",
                    url: "https://api2.cognizata.com/api/v2/wordcloud/getwordcloud/",
                    params: this.buildWordcloudDomainParams(),
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem("token"),
                        "Content-Type": "application/json",
                    },
                ...
                const domainResponse = await this.axios(domainConfig);
                this.wordcloudDomainData = domainResponse.data || null;
                this.wordcloudDomainLoading = false;
            } catch (error) {
                this.wordcloudDomainData = null;
                this.wordcloudDomainError = 'ไม่สามารถโหลด Wordcloud ได้';
                this.wordcloudDomainLoading = false;
            }
        },
        ...
        async apiTimelineUserPosts() {
            ...
            const config = {
                ...
                params: {
                    ...
                    ...(this.getResolvedSourceParam() ? { source: this.getResolvedSourceParam() } : {}),
    ...
    computed: {
        ...mapGetters([
            'getDataWordcloud','getLoadDataWordcloud'
        ]),
        location: {
            get() {
