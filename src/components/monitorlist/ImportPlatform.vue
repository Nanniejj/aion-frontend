    ...
    >
        ...
        >
            ...
            >
                ...
                >
                <b-button
                    @click="downloadCSVFromPublicFile('aion_target_url_with_label_xlsx.xlsx')"
...
.modal-body-scrollable::-webkit-scrollbar {
  width: 6px; /* << ขนาดความกว้างของ scrollbar แนวตั้ง */
}
.modal-body-scrollable {
  scrollbar-width: thin;              /* ทำให้ scrollbar บางลง */
  scrollbar-color: rgba(0, 0, 0, 0.2) transparent; /* สี scrollbar และ track */
}
</style>
