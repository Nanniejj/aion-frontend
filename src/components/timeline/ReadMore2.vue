...
export default {
  ...
  props: {
    ...
    // คำแปล + สถานะโชว์คำแปล/ต้นฉบับ — ควบคุมจาก parent เท่านั้น
    // (เช่น TranslateText โหมด combined ใน CardTitle.vue ที่แปล title+เนื้อหาพร้อมกันแล้ว emit กลับมา)
    // component นี้เป็น presentation-only ไม่มีปุ่มแปล/สลับของตัวเองอีกต่อไป
  ...
  data() {
    ...
    // ข้อความที่จะใช้แสดงจริง — สลับไปมาระหว่างต้นฉบับกับคำแปลตามที่ parent สั่ง
    baseText() {
