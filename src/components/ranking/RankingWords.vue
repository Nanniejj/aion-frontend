<template>
    <div>
            ...
            <b-row class="align-items-center px-3">
                <b-col md>
                    <div class="text-left">
                        ...
                        <span class="small text-grey">(จำนวนโพสต์ที่พบ)</span>
                    </div>
                </b-col>
                <b-col cols="12" md="auto" class="pt-2 pt-md-0">
                    <b-button-group size="sm" class="w-100">
                        <b-button v-for="m in modes" :key="m.value"
                            :variant="mode === m.value ? 'info' : 'outline-info'" @click="mode = m.value">
                            {{ m.label }}
                        </b-button>
                    </b-button-group>
                </b-col>
        ...
        <!-- {{ selectedWord }} -->
        <div id="all-post" v-if="word && selectedWord">
            <div class="mt-1  text-left">
                <span class="h5 bold">
                    <i class="fa fa-tag mr-2" aria-hidden="true"></i>{{ word }}
                </span>
            </div>
            <b-card class="card-platform">
                <!-- {{ datachart }} -->
                <div class="text-left text-tt mb-2 h6 " style="letter-spacing: 1.5px;">
                    Total <span class="h6 bold">{{ selectedWord.count | numFormat }}</span>Posts
                </div>
                <b-row>
                    <b-col cols="12" lg="5">
                        <SentimentBar :positive="selectedWord.pos || 0" :neutral="selectedWord.neu || 0"
                            :negative="selectedWord.neg || 0" class="py-2" />
                    </b-col>
                    <b-col cols="">
            ...
            <b-row class="mb-1 w-100 mx-0 justify-content-between align-items-center mt-3">
                <b-col cols="auto" sm="auto" md="6" lg="6" class="my-1 m-md-auto bold text-left h6 px-0">
                    <!-- <div class="bold text-left h6"> -->
                    All Posts | {{ word }}
                    <!-- </div> -->
                </b-col>
                <b-col cols="auto" sm="auto" md="6" lg="6" class="px-0 text-md-right">
            ...
            <b-row class="">
                <b-col sm="12" md="auto">
                    <b-form-radio-group v-model="postFilter.sentiment" :options="options" name="radio-inline"
                        class="mt-1 mb-2 ml-2"></b-form-radio-group>
                </b-col>
                <b-col md="">
                    <b-form-select :options="itemSocial" v-model="postFilter.social" id="search-input" size="sm"
                        class="mb-2 select-sort" placeholder="Select Platform"></b-form-select>
                </b-col>
                <b-col sm="12" md="" class="text-right">
                    <b-form-select v-model="postFilter.sortBy" :options="optionSort" size="sm"
                        class="mb-2 select-sort"></b-form-select>
                </b-col>
            </b-row>
                        ...
                        <b-row>
                            <b-col style="text-align: initial; display: contents">
                                <span v-if="datas.profile_image">
                                    <b-avatar @error="user" size="47px" :src="datas.profile_image" loading="lazy"
                                        class="imgpro" v-if="datas.source != 'blockdit'"></b-avatar>
                                    <b-avatar @error="user" size="47px" :src="datas.profile_image" loading="lazy"
                                        v-else></b-avatar>
                                </span>
                                ...
                                <span v-if="datas.source == 'pantip'">
                                    ...
                                    <img v-else-if="datas.platform == 'lemon8'" src="@/assets/lemon8.png"
                                        class="social-img" />
                            ...
                            <b-col style="text-align: initial">
                                ...
                                <span id="user-name">
                                    ...
                                    <a v-if="datas.url_post && datas.url_post.includes('mbasic')"
                                        ...
                                        target="_blank"></a>
                                    <a v-else v-bind:href="datas.url_post" class="fa fa-external-link"
                                        target="_blank"></a>
                                </span>
                            ...
                            <b-col sm="12" md="4" class="text-md-right mr-2">
                                <div>
                                    ...
                                    <i v-if="datas.snapshot" class="fas fa-camera mr-2"
                                    ...
                                    <span v-if="datas.user_sentiment">
                                        ...
                                        ">
                                            <b-button-group size="sm" id="btn-group"
                        ...
                        <b-col lg="12">
                            <b-card-body>
                                <b-card-text class="box-contents">
                                    ...
                                    <Highlighter v-if="datas.full_text" class="my-highlight md-font" :style="{
                                        textAlign: 'left',
                                        fontSize: '17px',
                                        padding: '10px',
                                    }" highlightClassName="highlight4" :searchWords="highlightText(datas.full_text)"
                                        :autoEscape="true" :textToHighlight="datas.read
                                            ? datas.full_text
                                                .replace('...___...', '')
                                                .replace('.#.##.', '')
                                                .slice(0, 450)
                                    ...
                                    <div v-if="datas.full_text.length > 450" @click="datas.read = !datas.read"
                                        id="readmore">
                    ...
                    <div class="text-left ai-box my-2 px-2" v-if="datas && datas.photos_text && datas.photos_text.length"
                        ...
                        <div v-for="(text, idx) in datas.photos_text">
                            ...
                            <div v-if="text && text.length">
                                <b-avatar size="20px" style="font-size: 12px;background-color:#4e6175;" class="mr-2">{{
                                    idx
                                    + 1 }}
                                </b-avatar>
                    ...
                    <div class="text-left ai-box my-2 px-2" v-if="datas && datas.ocr && username == 'adminatapy'"
                        ...
                        <div v-for="(text, idx) in datas.ocr">
                            ...
                            <div v-if="text.text_sort && text.text_sort.length">
                                <b-avatar size="18px" style="font-size: 12px;background-color:#8b8787;" class="mr-1">{{
                                    idx
                                    + 1 }}
                                </b-avatar>
                                <b-icon icon="textarea-t" scale="1.3"></b-icon> OCR :
...
">
                    ...
                    <div class="text-left ai-box my-2 px-2"
    ...
    border-radius: 13px;">
                    ...
                    <template #footer>
                      ...
                      <i class="fa fa-user-circle-o"/> {{comment.account_name}}</a> -->
                            ...
                            <span id="box-reaction" v-b-tooltip.hover title="Comments"
                            ...
                            <span v-if="datas.source !== 'facebook' && datas.source !== 'youtube'">
                                <span v-if="datas.retweets_count !== '0' && datas.retweets_count" id="box-reaction"
                                    v-b-tooltip.hover title="Retweet">
                                    <i class="fal fa-retweet"></i>
                                    {{ datas.retweets_count | numFormat }}
                                </span>
                                <span v-if="datas.likes_count !== '0' && datas.likes_count" id="box-reaction"
                                    v-b-tooltip.hover title="Like">
                                    <i class="fa fa-heart"></i>
                                    {{ datas.likes_count | numFormat }}
                                </span>
                                <span v-if="datas.shares_count !== '0' && datas.shares_count" id="box-reaction"
                                    v-b-tooltip.hover title="Share">
                                    <i class="fa fa-share"></i>
                                    {{ datas.shares_count | numFormat }}
                                </span>
                                <span v-if="datas.views_count !== '0' && datas.views_count" id="box-reaction"
                            ...
                            <span v-if="datas.reaction">
                                <span v-if="datas.reaction != ''">
                                    ...
                                    <span v-if="datas.reaction.Good">
                                        <span v-if="datas.reaction.Good !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Good Content">
                                    ...
                                    <span v-if="datas.reaction.Horror">
                                        <span v-if="datas.reaction.Horror !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Horror">
                                            <img v-if="datas.reaction.Horror !== '0'" src="@/assets/horror.png"
                                                id="emoji" />
                                    ...
                                    <span v-if="datas.reaction.Likes">
                                        <span v-if="datas.reaction.Likes !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Like">
                                            <img v-if="datas.reaction.Likes !== '0'" src="@/assets/fb_like.png"
                                                id="emoji" />
                                    ...
                                    <span v-if="datas.reaction.like">
                                        <span v-if="datas.reaction.like !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Like">
                                            <img v-if="datas.reaction.like !== '0'" src="@/assets/fb_like.png"
                                                id="emoji" />
                                    ...
                                    <span v-if="datas.reaction.shares">
                                        <span v-if="datas.reaction.shares !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Share">
                                    ...
                                    <span v-if="datas.reaction.share">
                                        <span v-if="datas.reaction.share !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Share">
                                    ...
                                    <span v-if="datas.reaction.Love">
                                        <span v-if="datas.reaction.Love !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Love">
                                            <img v-if="datas.reaction.Love !== '0'" src="@/assets/love.png"
                                                id="emoji" />
                                    ...
                                    <span v-if="datas.reaction.Wow">
                                        <span v-if="datas.reaction.Wow !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Wow">
                                    ...
                                    <span v-if="datas.reaction.Haha">
                                        <span v-if="datas.reaction.Haha !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Haha">
                                            <img v-if="datas.reaction.Haha !== '0'" src="@/assets/haha.png"
                                                id="emoji" />
                                    ...
                                    <span v-if="datas.reaction.Sad">
                                        <span v-if="datas.reaction.Sad !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Sad">
                                    ...
                                    <span v-if="datas.reaction.Angry">
                                        <span v-if="datas.reaction.Angry !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Angry">
                                            <img v-if="datas.reaction.Angry !== '0'" src="@/assets/angry.png"
                                                id="emoji" />
                                    ...
                                    <span v-if="datas.reaction.Hug">
                                        <span v-if="datas.reaction.Hug !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Hug">
                                    ...
                                    <span v-if="datas.reaction.view_count" v-b-tooltip.hover title="Views">
                                        <span v-if="datas.reaction.view_count !== ''" id="box-reaction"><i
                                                class="fas fa-eye"></i>
                                    ...
                                    <span v-if="datas.reaction.dislikes">
                                        <span v-if="datas.reaction.dislikes !== '0'" id="box-reaction" v-b-tooltip.hover
                                            title="Dislike">
                            ...
                            <!-- comment content -->
                            <b-collapse :id="'btn' + offset + k" class="mt-2"
                                            ...
                                            <b-row>
                                                ...
                                                <b-col lg="11">
                                                    <div>
                                                        ...
                                                        <span v-if="datas.source == 'youtube' && cmt.time"
            ...
            <ul class="pagination" v-if="datacount != 0">
                <li class="page-item" v-for="pageNumber in totalPages" :key="pageNumber">
                    <span v-if="
                        ...
                        pageNumber == 1
                    ">
                        <a class="page-link md-font" v-bind:key="pageNumber" href="#allpost"
                            @click="setPage(pageNumber)" :class="{
...
export default {
    components: { TopWordCard, SentimentBar, PlatformBarChart, VueGallerySlideshow, Highlighter },
    props: {
        domains: {
            type: Array,
            required: true,
    ...
    computed: {
        ...
        platform() {
            const p = this.selectedWord?.platform || {}

            return {
                facebook: p.facebook || 0,
                twitter: p.twitter || 0,
                ...
                news: p.news || 0,
                tiktok: p.tiktok || 0,
                blockdit: p.blockdit || 0,
                threads: p.threads || 0,

                // summary
                totalPost: Object.values(p).reduce((sum, v) => sum + (v || 0), 0),
                Accounts: this.selectedWord?.accounts || 0,
                comments_count: this.selectedWord?.comments_count || 0,
                likes_count: this.selectedWord?.likes_count || 0,
                retweets_count: this.selectedWord?.retweets_count || 0,
            }
        },
    },
    data() {
    ...
    methods: {
        setPage(page) {
            ...
            this.apiSpotNewsPost(this.offset);
            this.$nextTick(() => {
                const el = document.getElementById("all-post");
                if (el) {
                    el.scrollIntoView({
                    behavior: "smooth",
                    block: "start"
        ...
        onClick(i, photos) {
            this.index = i;
            // บังคับให้เป็น array ของ string
            if (Array.isArray(photos)) {
                this.dataPhoto = photos;
        ...
        apiSpotNewsPost(offset) {
            ...
            // ------------------------
            let stm = "";
            if (this.postFilter.sentiment == "1,0,-1") { stm = ""; } else {
                stm = this.postFilter.sentiment;
            }
            // ------------------------
            // 3) date fallback
            // ------------------------
            ...
            // ------------------------
            const params = {
                domain: this.selectedWord.domain_id,
                ...(this.selectedWord.subdomain_id && {
                    subdomain: this.selectedWord.subdomain_id
                }),
                ...(this.selectedWord.object_id && {
                    objects: this.selectedWord.object_id
                }),
                // objects: 442,
                sentiment: stm || "",
                source: this.postFilter.social || "",
                sort_by: this.postFilter.sortBy || "",
                limit: 10,
        ...
        check_sentiment_word(name) {
            ...
            const { domain_name, object_id, subdomain_name } = this.selectedWord;

            // สร้าง query เพิ่มเฉพาะกรณีที่ต้องส่ง
            let extraQuery = "";

            if (object_id) {
                extraQuery = `&name=${encodeURIComponent(name)}`;
            } else if (subdomain_name) {
                extraQuery = `&subdomain=${encodeURIComponent(subdomain_name)}`;
            }
            // ถ้าไม่เข้าเงื่อนไขไหนเลย → extraQuery = ""

            const url =
                `https://api2.cognizata.com/api/v2/object/check_sentiment_word` +
                `?domain=${encodeURIComponent(domain_name)}${extraQuery}`;
            ...
            this.axios({
                ...
                .then(({ data }) => {
                    ...
                    this.heightword = result.Keywords || [];
                    this.andkey = (result.and_keywords || []).map(k => k.split("+"));
                })
                .catch((error) => {
        ...
        onSelectItem(item) {
            ...
            this.word = item.name;
            this.selectedWord = item.raw;
            this.check_sentiment_word(this.selectedWord.name || this.selectedWord.domain_name)
