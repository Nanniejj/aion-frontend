            ...
            <b-row class="">
                <b-col sm="12" md="auto">
                    <b-form-radio-group v-model="selected" :options="options" name="radio-inline"
                        class="mt-1 mb-2 text-left ml-2" @change="selectSentiment"></b-form-radio-group>
                </b-col>
                <b-col md="">
                    <b-form-select :options="itemSocial" v-model="select_social" @change="selectSort" id="search-input"
                        size="sm" class="mb-2 select-sort" placeholder="Select Platform"></b-form-select>
                </b-col>
            ...
            <b-card no-body class="overflow-hidden" header-tag="header" footer-tag="footer"
                ...
                ></Highlighter> -->
                                <Highlighter class="my-highlight md-font" :style="{
                                    ...
                                    fontSize: '17px',
                                    padding: '10px',
                                }" highlightClassName="highlight4" :searchWords="highlightText(heightword)"
                                    :autoEscape="true" :textToHighlight="datas.read ? datas.full_text.slice(0, 450) : datas.full_text
                                        "></Highlighter>
    ...
    methods: {
        ...
        apiSpotNewsPost(offset) {
            ...
            if (this.selected == "1,0,-1") {
                ...
                // console.log("sety", this.selected, typeof this.selected);
            ...
            var config = {
                ...
                params: {
                    ...
                    sort_by: this.sort,
                    domain: this.$route.query.domain_id,
                    subdomain: this.$route.query.subdomain_id,
