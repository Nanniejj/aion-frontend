<template>
  <div style="background-color: #eeeeee9c;border-radius: 10px;" class="section-report">
    ...
    <div class="box-post container">
      <b-card class="mb-4" style="border: none" id="box-content" footer-tag="footer" header-tag="header"
        v-for="(profilePost, k) in list" :key="profilePost.url_post">
        <vue-element-loading :active="getLoadFeed" size="80" background-color="rgba(255, 255, 255, 0.4)"
          color="#b6ac9a" />
        <template #header v-if="profilePost">
          <div class="text-right">
            ...
            <b-form-checkbox class="order-index " v-model="profilePost.selected" :value="true" size="lg"
              :unchecked-value="false" style="cursor : pointer" @change="togglePostSelection(k, profilePost.selected)">
              <span style="font-size: medium; width:40px !important;">
                เลือกโพสต์</span><span v-show="profilePost.selected">
                <span style="font-size: medium;">ที่</span>
                <b-avatar style="background-color: #f7dca2;" size="25" class="mx-2" variant="warning">
          ...
          <b-row>
            <b-col class="align-start col-lg-auto w-auto" sm="auto" lg="auto">
              <span class="left">
                ...
                <img v-if="profilePost.source == 'pantip'" src="@/assets/Pantip.png" class="social-img" />
          ...
          <b-col lg="12">
            ...
            <b-card-text class="box-contents">
              <Highlighter class="my-highlight md-font" :style="{
                ...
                fontSize: '17px',
                padding: '10px',
              }" highlightClassName="highlight4" :searchWords="highlightText(profilePost.full_text)"
    ...
    border-radius: 13px;">
        ...
        <template #footer>
          <div class="text-left">
            ...
            <span v-b-toggle="'btn' + page + k" :aria-expanded="visible ? 'true' : 'false'" style="cursor: pointer"
              id="box-reaction" v-b-tooltip.hover title="Comments">
