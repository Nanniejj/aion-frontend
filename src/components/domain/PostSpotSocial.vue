  ...
  <div id="hottopic" class="container">
    ...
    <div class="mt-md-5 p-1">
      ...
      <div class="mb-3 text-left mb-5 ">
        ...
        <div class="text-center my-6 px-5 d-none">
          <span v-if="topics.length <= 200" class="h5">
            " {{ topics }} "
          </span>

          <template v-else>
            <span v-if="showFull" class="h5">
              " {{ topics }} "
            </span>
      ...
      <b-row class="mb-1 justify-contents-between">
    ...
    <!-- <ul class="pagination" v-if="datacount != 0">
      <li class="page-item" v-for="pageNumber in totalPages" :key="pageNumber">
        <span v-if="
          ...
          pageNumber == 1
        ">
          <a class="page-link md-font" v-bind:key="pageNumber" href="#hottopic" @click="setPage(pageNumber)" :class="{
...
export default {
 ...
 filterNumbers(numbers) {
    ...
    apiSpotNewsPost() {
      ...
      var config = {
        method: "get",
        url: "https://api2.cognizata.com/api/v2/userposts/getHottopicslistId",
        params: {
          sentiment: stm || "",
