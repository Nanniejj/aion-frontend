        ...
        <b-col>
          <b-card class="mb-4" style="border: none" id="box-content" footer-tag="footer" header-tag="header">
            ...
            <b-row>
              <b-col md="12"> </b-col>
              <b-col lg="12">
                <div v-if="postDomain && postDomain.news_info && postDomain.news_info.source_news == 'external'"
                  class="info-news text-right my-1 small ">
                  <span v-if="postDomain.news_info.source_news == 'external'">ข่าวต่างประเทศ</span>
            ...
            <div class="text-left ai-box my-2"
            ...
            <div class="text-left ai-box my-2" v-if="postDomain && postDomain.ocr && username == 'adminatapy'"
              style="font-size: 15px;font-weight: 500;">
...
">
            ...
            <div class="text-left ai-box my-2" v-if="postDomain && postDomain.face_detect && username == 'adminatapy'"
              style="font-size: 15px;font-weight: 500;">
