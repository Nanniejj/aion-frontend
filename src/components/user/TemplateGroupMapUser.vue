<template>
  <span>
    <span class="fas fa-list-ul" v-b-tooltip.hover title="การจัดการบัญชี" size="sm" @click="openModal(items)"></span>
      ...
      <b-container fluid>
        ...
        <b-card class="my-3">
          ...
          <b-row>
            ...
            <b-col cols="12" md="10" class="py-2">
              <!-- {{ items.projectname }} -->
              <v-select v-on:input="onChangenProject()" :options="optionProject"
                v-model="projectnameselected"></v-select>
            </b-col>
            <b-col cols="12" md="2" class="bold py-2">
              Domain
            </b-col>
            <b-col cols="12" md="10" class="py-2">
              <b-button v-b-toggle.collapse-1 variant="warning" block class="btn-slide" size="sm">
                <b-icon icon="eye-fill" aria-hidden="true" class="mr-2">
                </b-icon>
                Domain
              </b-button>
              <b-collapse id="collapse-1" class="mt-2">
                <b-card style="max-height: 200px;
    text-align: left;
    overflow: auto;">
            ...
            <b-col cols="12" md="10" class="py-2">
              <b-button v-b-toggle.collapse-2 variant="warning" block class="btn-slide" size="sm">
                <b-icon icon="eye-fill" aria-hidden="true" class="mr-2">
                </b-icon>
                Hashtag
              </b-button>
    ...
    overflow: auto;">
                ...
                <b-row>
                  ...
                  <b-col>
                    <span class="ml-3 mr-3">
                      <span class="fa fa-trash-alt" v-b-tooltip.hover title="ลบ device" size="sm"
                        v-on:click="delDevice(device.id)" style="cursor: pointer;"></span></span>
                  </b-col>
                </b-row>
                <b-row>
        ...
        <b-row class="my-1">
          <b-col sm="12" style="text-align:right;">
            ...
            <b-button class="btn btn-save mx-2" size="sm" @click="submitform()">บันทึก</b-button>
          </b-col>
        </b-row>
      </b-container>
    </vue-modaltor>
